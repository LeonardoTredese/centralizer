...
class Remote:
    ...
    def login(self, username= self.user, password= self.passw):
        ''' Logs in self.client in the remote host, if self.use_sudo is true upgrades ssh session to super user

            Args:
                username: the name of the user that will login in the remote host. str or unicode, default self.user
                password: the password used for the login and eventually the sudo upgrade. str or unicode, default self.passw
            Retrurns:
